object FrmAjandaListe: TFrmAjandaListe
  Left = 0
  Top = 0
  Caption = 'Ajanda Listesi'
  ClientHeight = 617
  ClientWidth = 1222
  Color = clWhite
  ...
  object AdvAjanda: TAdvStringGrid
    Left = 0
    Top = 124
    Width = 1222
    Height = 493
    ...
    ScrollBars = ssBoth
    TabOrder = 2
    OnDblClick = AdvAjandaDblClick
    OnGetAlignment = AdvAjandaGetAlignment
    OnCanEditCell = AdvAjandaCanEditCell
    OnCheckBoxClick = AdvAjandaCheckBoxClick
