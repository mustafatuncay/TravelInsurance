object FrmSirketGelirGiderListe: TFrmSirketGelirGiderListe
  Left = 0
  Top = 0
  Caption = #350'irket Gelir - Gider Listesi'
  ClientHeight = 617
  ClientWidth = 1222
  Color = clWhite
  ...
  object Panel1: TPanel
    ...
    object Label1: TLabel
      ...
      Alignment = taCenter
      AutoSize = False
      Caption = #350#304'RKET GEL'#304'R - G'#304'DER L'#304'STES'#304
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -21
      Font.Name = 'Tahoma'
  ...
  object AdvSirket: TAdvStringGrid
    Left = 0
    Top = 124
    Width = 1222
    Height = 493
    ...
    ScrollBars = ssBoth
    TabOrder = 2
    OnDblClick = AdvSirketDblClick
    OnGetAlignment = AdvSirketGetAlignment
